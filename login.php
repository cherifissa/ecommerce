                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="usersrequestes/login.php" method="POST">
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Connecter-vous à
                                            votre compte</h5>
                                        ...
                                        <div class="form-outline mb-4">
                                           afficher mot de passe le <input type="checkbox" name="chow" id="">                                            
                                        </div>
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">vous n'avez pas de compte? <a
                                                href="signin.php" style="color: #393f81;">creer-un</a></p>
