...
if ($_SESSION['admin'] != "Non connecté") {
        echo '<script>
        alert("Vous etes deja connectez ADMIN !");
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="adminrequestes/login.php" method='POST'>
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Connecter-vous en
                                            tan qu'administrateur</h5>
